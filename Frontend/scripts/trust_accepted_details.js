...
async function fetchAcceptedDonations() {
  ...
  tableBody.innerHTML = '<tr><td colspan="6" style="text-align:center;">Loading records...</td></tr>';
  ...
  try {
    ...
    if (response.ok === true) {
      ...
      if (acceptedList.length === 0) {
        tableBody.innerHTML = '<tr><td colspan="6" style="text-align:center;">No accepted requests found.</td></tr>';
      } else {
    ...
    tableBody.innerHTML = '<tr><td colspan="6" style="text-align:center;color:red;">Error loading records. Please refresh.</td></tr>';
  }
}
