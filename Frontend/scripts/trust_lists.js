...
async function loadTrustList() {
  ...
  container.innerHTML =
    '<div style="text-align:center;padding:40px;width:100%;grid-column:1/-1;">Finding trusts...</div>';
  ...
  try {
    ...
    if (response.ok) {
      ...
      container.innerHTML = trusts.length
        ? ""
    ...
    container.innerHTML =
      '<div style="text-align:center;color:red;width:100%;grid-column:1/-1;padding:40px;">Connection error.</div>';
  }
}
